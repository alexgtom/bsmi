  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deadline as @deadline" do
        ...
        post :create, {:deadline => { "title" => "invalid value" }}, valid_session
        assigns(:deadline).should be_a_new(Deadline)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deadline" do
        ...
        Deadline.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => deadline.to_param, :deadline => { "title" => "MyString" }}, valid_session
      end
